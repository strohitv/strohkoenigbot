...
//	private final ConfigFileConnector configFileConnector;
	...
	public boolean refreshGToken(Runtime rt, String configFileLocation, String completeCommand) {
		...
		// calling the s3s runner more than once is currently useless as it cannot refresh the tokens for itself.
		// instead, a tool like splatnet3-token-util needs to extract the tokens and s3s will either work (= tokens good, load) or fail (= tokens bad, do nothing)
//		int number = 0;
