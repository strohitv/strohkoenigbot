...
public interface Splatoon3VsRotationSlotRepository extends CrudRepository<Splatoon3VsRotationSlot, Long> {
	...
	Optional<Splatoon3VsRotationSlot> findByRotation_ModeAndStartTimeBeforeAndEndTimeAfter(Splatoon3VsMode mode, Instant startTimeBefore, Instant endTimeAfter);
}
