...
@Getter
public enum SplatoonSalmonRunWeapon {
	...
	SplatoonSalmonRunWeapon(long flag, String name, String... altNames) {
		this.flag = flag;
		this.name = name;
		this.altNames = altNames;
	}

	public static final List<SplatoonSalmonRunWeapon> All = EnumSet.allOf(SplatoonSalmonRunWeapon.class).stream().sorted(Comparator.comparingLong(a -> a.flag)).collect(Collectors.toList());
}
